      ...
      <div className="space-y-0">
        ...
        >
          ...
          <ul className="ml-4 list-disc space-y-1.5">
            ...
            <li>
              ...
              : rough coordinate box around your region, used for data validation and map
              fitting
            </li>
            <li>
              <code className="rounded bg-muted px-1 py-0.5 font-mono text-xs">
              ...
              : display order for the city filter (anything in your data but missing here
            ...
            <li>
              ...
              : swap the sample imports for your own{" "}
              <code className="rounded bg-muted px-1 py-0.5 font-mono text-xs">
                data/places/*.json
              </code>{" "}
              files
          ...
          <p>
            ...
            has two minimal example entries if you want to start from a clean skeleton
            instead of the dataset that ships with the template.
          </p>
        ...
        >
          ...
          <ul className="ml-4 list-disc space-y-1.5">
            ...
            <li>
              The Supabase variables are optional. Leave them blank and the map, filters,
              and calendar all work; you just won&apos;t get sign-in or the two private
              features in step 5.
            </li>
          </ul>
        </StepCard>
        ...
        >
          <p>
            These three features (sign-in, saved custom places, personal calendar events)
            need a Supabase project. Skip this whole step if you only want the public map
            and calendar.
          </p>
          <ol className="ml-4 list-decimal space-y-1.5">
            ...
            <li>
              ...
              , in filename order. Each one creates its tables with row-level security
              already scoped to{" "}
              <code className="rounded bg-muted px-1 py-0.5 font-mono text-xs">
                auth.uid()
              </code>
        ...
        >
          ...
          <p className="text-xs text-muted-foreground">
            ...
            Sign-in needs a live server: the OAuth callback route exchanges a code for a
            session server-side, and middleware refreshes that session on every request.
            Both are incompatible with a static build. Deploy to a normal server/edge
            runtime instead - that&apos;s the default for Vercel and most other Next.js
            hosts.
          </p>
        </StepCard>
      </div>
