    ...
    <>
      <div className="space-y-0">
        <StepCard
          ...
          description="You qualify if all of these are true"
        >
          <ul className="ml-4 list-disc space-y-2">
            <li>You are at least 13 years old.</li>
            <li>
              You are currently enrolled in a degree- or diploma-granting course of study
              (school, college, university, or a homeschool equivalent).
            </li>
            <li>
              You have a verifiable school-issued email address, or documents that prove
              your current student status (student ID card, enrolment letter, fee receipt
              with a current date).
            </li>
        ...
        >
          <ul className="ml-4 list-disc space-y-2">
            ...
            <li>
              Otherwise: photograph your school ID card or a dated enrolment document. The
              name on the document must match your GitHub profile name.
            </li>
            <li>
              GitHub asks you to capture the document with your device camera during the
              application, so keep the physical document handy.
            </li>
          </ul>
        </StepCard>
        ...
        <StepCard step={3} title="Apply" description="Takes about 10 minutes">
          <ol className="ml-4 list-decimal space-y-2">
            ...
            <li>
              Enable two-factor authentication and complete your GitHub profile (real name
              and bio) before submitting. Incomplete profiles are a common rejection
              reason.
            </li>
            <li>
              Submit and wait. Most applications process within a few days; peak periods
              can take longer.
            </li>
          </ol>
        </StepCard>
        ...
        <StepCard
          ...
          description="What you actually get"
          isLast
        >
          <ul className="ml-4 list-disc space-y-2">
            <li>
            ...
            <li>
              ...
              (DigitalOcean, Azure for Students, Heroku), JetBrains IDEs, and dozens more.
              Each redeemed from the pack page.
            </li>
            <li>
          ...
          <p className="text-xs text-muted-foreground">
            Rejected? Most common causes: mismatched names, undated documents, missing
            two-factor authentication. Fix the issue and reapply. No penalty.
          </p>
        </StepCard>
      </div>
