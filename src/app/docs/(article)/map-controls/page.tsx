      ...
      <div className="space-y-4">
          ...
          <CardContent className="text-sm text-foreground/80">
            <ul className="ml-4 list-disc space-y-2">
              <li>
                ...
                <span className="font-medium">Cmd</span> on Mac) and scroll to zoom - a
                brief hint appears if you scroll over the map without it held.
              </li>
              <li>
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm text-foreground/80">
            <p>
              Where pins are close together, they group into a circle showing a count and
              a color split by place type. Click or tap a cluster to zoom into it; it
              keeps splitting into smaller clusters and eventually individual pins as you
              zoom in.
            </p>
            <p>
              Clicking an individual pin opens a popup with its name, type, and Directions
              / Copy Link actions. Press <span className="font-medium">Escape</span>, or
              click elsewhere on the map, to close it.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="text-sm text-foreground/80">
            <ul className="ml-4 list-disc space-y-2">
              ...
              <li>
                <span className="font-medium">Share:</span> copies a link that reopens the
                map with your current filters and selection applied.
              </li>
            </ul>
          </CardContent>
        </Card>
