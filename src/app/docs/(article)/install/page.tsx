        ...
        <Card>
          ...
          <CardContent className="text-sm text-foreground/80">
            <ul className="ml-4 list-disc space-y-2">
              <li>
                <span className="font-medium">Android (Chrome):</span> tap the ⋮ menu and
            ...
            <p className="mt-3 text-xs text-muted-foreground">
              ...
              browser&apos;s native feature, driven by the app&apos;s manifest and service
              worker.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm text-foreground/80">
            <p>
              ...
              the network first and fall back to the cache when offline; static assets and
              tiles are cache-first since they don&apos;t change under the same URL.
            </p>
            <p>
      ...
      >
        ...
        <ol className="ml-4 list-decimal space-y-1.5">
          ...
          <li>
            ...
            dev tools (Application tab in Chrome/Edge, Storage in Firefox), clear Service
            Workers, Cache Storage, and Storage for the site, then reload.
          </li>
          <li>
            <span className="font-medium">Reinstall the PWA:</span> if you installed it to
            your home screen, remove it and reinstall from the site.
          </li>
        </ol>
        <p className="text-xs text-muted-foreground">
