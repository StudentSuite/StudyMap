    ...
    <>
      <div className="space-y-4">
        <CalloutCard title="How accurate is the data?">
          <p>
            Every place was added by a contributor through GitHub, with a required 4.0+
            Google Maps rating and 50+ reviews at the time of submission - but that proof
            lives in the pull request, not as an automated check, so it&apos;s
            honor-system rather than machine-verified. Places can also go stale (closed,
            moved, hours changed) after being added. See{" "}
            <Link
        ...
        <CalloutCard title="Why isn't my school or a place I know listed?">
          <p>
            Either nobody has submitted it yet, or it didn&apos;t clear the quality gate:
            a 4.0+ Google Maps rating, 50+ reviews, and confirmation it&apos;s real and
            currently operating. Add it yourself via the{" "}
            <span className="font-medium">Suggest a place</span> button on the map, or see{" "}
            <Link
        ...
        <CalloutCard title="Do I need an account to use StudyMap?">
          <p>
            No. The map, search, filters, and exam calendar all work fully without signing
            in. An account is only needed for two optional, private features: saving your
            own places and a home location, and adding personal events to the calendar -
            neither of which are visible to anyone else.
          </p>
        </CalloutCard>
        ...
        <CalloutCard title="What's the difference between adding a place and saving one?">
          <p>
            ...
            never appears on anyone else&apos;s map - it&apos;s a personal bookmark, not a
            public contribution.
          </p>
        </CalloutCard>
      </div>
