        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm text-foreground/80">
            ...
            <p>
              ...
              , add it to{" "}
              <code className="rounded bg-muted px-1.5 py-0.5 font-mono">.env.local</code>{" "}
              as{" "}
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm text-foreground/80">
            <p>
              ...
              checks for Postgres error{" "}
              <code className="rounded bg-muted px-1.5 py-0.5 font-mono">PGRST205</code>{" "}
              (&quot;table not found in schema cache&quot;) and shows a message pointing
              here instead of a generic failure.
            </p>
            <p>
            ...
            <p className="text-xs text-muted-foreground">
              If you don&apos;t need auth at all, leave the Supabase env vars blank. The
              map, search, filters, and calendar all work without them - you just lose
              sign-in, saved places, and personal events.
            </p>
          </CardContent>
        </Card>
            ...
            <ul className="ml-4 list-disc space-y-2">
              <li>
                <span className="font-medium">
                  No prompt appeared, or it&apos;s silently doing nothing:
                </span>{" "}
                the browser doesn&apos;t support the Geolocation API, or the page
                isn&apos;t served over HTTPS (required by most browsers outside{" "}
                <code className="rounded bg-muted px-1.5 py-0.5 font-mono">
                  localhost
                </code>
                ).
              ...
              <li>
                ...
                location permission was denied, or the device couldn&apos;t get a fix.
                Check the browser&apos;s site permissions and try again.
              </li>
              <li>
                <span className="font-medium">Location seems wrong:</span> some browsers
                fall back to IP-based location when GPS/Wi-Fi positioning is unavailable,
                which can be off by kilometers, especially on desktop.
              </li>
            </ul>
          </CardContent>
        </Card>
