  ...
  return (
    <PageContainer>
      ...
      <p className="mt-2 max-w-2xl text-muted-foreground">
        Upcoming SAT, IB, and Cambridge IGCSE exam windows and result dates. Every date
        links back to the official board source. Provisional entries are marked until the
        board confirms its timetable.
      </p>
      ...
      <p className="mt-8 text-xs text-muted-foreground">
        ...
        International. Always confirm with your school or test centre before planning.
        Boards occasionally revise timetables.{" "}
